...
public class ParserTests
{
    ...
    public async Task Parser_BinaryExpression_HonorsPrecedence(SyntaxKind op1, SyntaxKind op2)
    {
        var action = () =>
        {
    ...
    public async Task Parser_UnaryExpression_HonorsPrecedence(SyntaxKind unaryKind, SyntaxKind binaryKind)
    {
        var action = () =>
        {
