...
public class HelloSourceGenerator : ISourceGenerator
{
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        var syntaxTreeType = context.Compilation.GetTypeByMetadataName("Wired.CodeAnalysis.Syntax.SyntaxTree");
        var syntaxNodeType = context.Compilation.GetTypeByMetadataName("Wired.CodeAnalysis.Syntax.SyntaxNode");
